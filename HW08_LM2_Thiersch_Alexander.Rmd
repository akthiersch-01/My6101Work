...
The correlation matrices between Pearson and Spearmon are relatively similar. However, The Spearman's correlation matrix does display correlation coefficients that are large that the Pearson'correlation matrix.
